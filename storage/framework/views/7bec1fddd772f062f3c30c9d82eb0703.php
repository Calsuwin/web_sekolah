  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="<?php echo e(route('siswa')); ?>">Siswa</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container my-5">
      ...
      <div class="row g-4">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="card h-100 shadow">
            <img src="<?php echo e(asset('storage/' . $siswa->image)); ?>" class="card-img-top" alt="<?php echo e($siswa->nama_siswa); ?>" style="height: 220px; object-fit: cover;">
            <div class="card-body">
              <h5 class="card-title"><?php echo e($siswa->nama_siswa); ?></h5>
              <h6 class="card-subtitle mb-2 text-muted"><?php echo e($siswa->kode_siswa); ?> | <?php echo e($siswa->jurusan_kelas); ?></h6>
              <p class="card-text"><?php echo e($siswa->deskripsi); ?></p>
            </div>
          </div>
        </div>
      ...
      <?php if($siswas->isEmpty()): ?>
        <div class="alert alert-info mt-4 text-center">Belum ada data siswa.</div>
      <?php endif; ?>
    </div>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.6/dist/js/bootstrap.bundle.min.js"></script>
  </body>
</html><?php /**PATH C:\laragon\www\UKK_PPLG2_AZMI\resources\views/Siswa.blade.php ENDPATH**/ ?>