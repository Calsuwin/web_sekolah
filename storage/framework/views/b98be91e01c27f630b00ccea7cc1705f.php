...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="<?php echo e(route('jurusan')); ?>">Jurusan</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container my-5">
      <h1 class="mb-4 text-center">Daftar Jurusan</h1>
      <div class="row g-4">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="card h-100 shadow">
            <img src="<?php echo e(asset('storage/' . $jurusan->image)); ?>" class="card-img-top" alt="<?php echo e($jurusan->nama_jurusan); ?>" style="height: 220px; object-fit: cover;">
            <div class="card-body">
              <h5 class="card-title"><?php echo e($jurusan->nama_jurusan); ?></h5>
              <h6 class="card-subtitle mb-2 text-muted"><?php echo e($jurusan->kode_jurusan); ?></h6>
              <p class="card-text"><?php echo e($jurusan->deskripsi); ?></p>
            </div>
          </div>
        </div>
      ...
      <?php if($jurusans->isEmpty()): ?>
        <div class="alert alert-info mt-4 text-center">Belum ada data Jurusan.</div>
      <?php endif; ?>
    </div>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.6/dist/js/bootstrap.bundle.min.js"></script>
  </body>
</html><?php /**PATH C:\laragon\www\UKK_PPLG2_AZMI\resources\views/Jurusan.blade.php ENDPATH**/ ?>