    ...
    <div id="carouselExampleCaptions" class="carousel slide">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="<?php echo e(asset('storage/corasuel/Dokumen-1.jpeg')); ?>" class="d-block w-100" alt="...">
        ...
        <div class="carousel-item">
          <img src="<?php echo e(asset('storage/corasuel/lapang2.jpg')); ?>" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
          <img src="<?php echo e(asset('storage/corasuel/main (2).jpg')); ?>" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
...
<div class="container my-5">
  <div class="row g-3">
    <div class="col-6 col-md-4 col-lg-3">
      <img src="<?php echo e(asset('storage/corasuel/main (1).jpg')); ?>" class="gallery-img rounded" alt="Foto 1">
      <div class="gallery-caption">Ini Adalah Tempat Praktek TBSM</div>
    </div>
    <div class="col-6 col-md-4 col-lg-3">
      <img src="<?php echo e(asset('storage/corasuel/main (2).jpg')); ?>" class="gallery-img rounded" alt="Foto 2">
      <div class="gallery-caption">Ini Adalah Tempat Praktek PPLG</div>
    </div>
    <div class="col-6 col-md-4 col-lg-3">
      <img src="<?php echo e(asset('storage/corasuel/main (3).jpg')); ?>" class="gallery-img rounded" alt="Foto 3">
      <div class="gallery-caption">Ini Adalah Tempat Praktek TKJT</div>
    </div>
    <div class="col-6 col-md-4 col-lg-3">
      <img src="<?php echo e(asset('storage/corasuel/mesjid1.jpg')); ?>" class="gallery-img rounded" alt="Foto 4">
...
</html><?php /**PATH C:\laragon\www\UKK_PPLG2_AZMI\resources\views/Beranda.blade.php ENDPATH**/ ?>