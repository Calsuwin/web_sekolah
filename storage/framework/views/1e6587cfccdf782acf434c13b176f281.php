      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="<?php echo e(route('guru')); ?>">Guru</a>
            </li>
            <li class="nav-item">
      ...
      <div class="row g-4">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="card h-100 shadow">
            <img src="<?php echo e(asset('storage/' . $guru->image)); ?>" class="card-img-top" alt="<?php echo e($guru->nama_guru); ?>" style="height: 220px; object-fit: cover;">
            <div class="card-body">
              <h5 class="card-title"><?php echo e($guru->nama_guru); ?></h5>
              <h6 class="card-subtitle mb-2 text-muted"><?php echo e($guru->kode_guru); ?> | <?php echo e($guru->mapel); ?></h6>
              <p class="card-text"><?php echo e($guru->deskripsi); ?></p>
            </div>
          </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
      <?php if($gurus->isEmpty()): ?>
        <div class="alert alert-info mt-4 text-center">Belum ada data guru.</div>
      <?php endif; ?>
    </div>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.6/dist/js/bootstrap.bundle.min.js"></script>
  </body>
</html><?php /**PATH C:\laragon\www\UKK_PPLG2_AZMI\resources\views/Guru.blade.php ENDPATH**/ ?>