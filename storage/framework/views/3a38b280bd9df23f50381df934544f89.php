        ...
        <div class="carousel-inner">
            <?php $__currentLoopData = $carousels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $carousel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="carousel-item <?php echo e($key == 0 ? 'active' : ''); ?>">
                    <img src="<?php echo e(asset('storage/' . $carousel->image)); ?>" class="d-block w-100" alt="<?php echo e($carousel->title); ?>">
                    <div class="carousel-caption d-block text-start bg-dark bg-opacity-75 p-4"
                        style="bottom:0; left:0; right:0;">
                        <p class="text-warning mb-1"><?php echo e($carousel->title); ?></p>
                        <h4>
                            <a href="<?php echo e($carousel->link ?? '#'); ?>" id="custom-text" class="text-white text-decoration-none">
            ...
            <div class="row g-3">
                <div class="col-md-4 artikel">
                    <div class="card h-100" data-aos="fade-right">
                        <img src="<?php echo e(asset('storage/images/2.jpg')); ?>" class="img-fluid w-100 rounded"
                ...
                <div class="col-md-4 artikel">
                    <div class="card h-100" data-aos="fade-left">
                        <img src="<?php echo e(asset('storage/images/4.jpg')); ?>" class="img-fluid w-100 rounded"
                            style="height:250px; object-fit:cover;" data-aos="fade-up" alt="">
                        <div class="card-body">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\azmi\web_sekolah\resources\views/index.blade.php ENDPATH**/ ?>