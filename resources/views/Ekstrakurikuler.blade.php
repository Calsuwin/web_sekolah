      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="{{ route('ekstrakurikuler') }}">Ekstrakurikuler</a>
            </li>
            <li class="nav-item">
      ...
      <div class="row g-4">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="card h-100 shadow">
            <img src="{{ asset('storage/' . $ekstrakurikuler->image) }}" class="card-img-top" alt="{{ $ekstrakurikuler->nama_ekstrakurikuler }}" style="height: 220px; object-fit: cover;">
            <div class="card-body">
              <h5 class="card-title">{{ $ekstrakurikuler->nama_jurusan }}</h5>
              <h6 class="card-subtitle mb-2 text-muted">{{ $ekstrakurikuler->kode_ekstrakurikuler }}</h6>
