        ...
        <div class="row">
            ...
            <div class="col-md-2 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="{{ route('profil.index') }}" class="text-white text-decoration-none">Profil Sekolah</a>
                    </li>
                    <li><a href="{{ route('jurusan') }}" class="text-white text-decoration-none">Jurusan</a></li>
                    <li><a href="{{ route('eskul') }}" class="text-white text-decoration-none">Eskul</a></li>
