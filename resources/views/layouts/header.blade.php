            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse text-right" id="navbarText">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item {{ request()->is('profil/sejarah') ? 'active' : '' }}"
                                        href="{{ route('profil.sejarah') }}">Sejarah</a></li>
                                <li><a class="dropdown-item {{ request()->is('profil/visi-misi') ? 'active' : '' }}"
                                        href="{{ route('profil.visi-misi') }}">Visi & Misi</a></li>
                                <li><a class="dropdown-item {{ request()->is('profil/data-pokok') ? 'active' : '' }}"
                                        href="{{ route('profil.data-pokok') }}">Data Pokok</a></li>
                                <li><a class="dropdown-item {{ request()->is('profil/data-statistik') ? 'active' : '' }}"
                                        href="{{ route('profil.data-statistik') }}">Data Statistik</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('eskul') ? 'active' : '' }}"
                                href="{{ route('eskul') }}">
                                Ekstrakurikuler
                            </a>
                        </li>
