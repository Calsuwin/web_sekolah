    ...
    <div class="container mt-5">
      <div class="row align-items-center">
        <div class="col-md-4 text-center mb-4 mb-md-0">
          <img src="{{ asset('storage/corasuel/Logo_SMK_Negeri_4_Tasikmalaya.png') }}" alt="Logo SMKN 4 Tasikmalaya" class="img-fluid rounded shadow" style="max-width: 220px;">
        </div>
        <div class="col-md-8">
      ...
      <div class="row mt-5">
        ...
        <div class="col-6 col-md-3 mb-3">
          <img src="{{ asset('storage/corasuel/Dokumen-1.jpeg') }}" class="gallery-img rounded" alt="Perpustakaan">
