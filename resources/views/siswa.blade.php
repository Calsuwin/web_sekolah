      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="{{ route('siswa') }}">Siswa</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="row g-4">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="card h-100 shadow">
            <img src="{{ asset('storage/' . $siswa->image) }}" class="card-img-top" alt="{{ $siswa->nama_siswa }}" style="height: 220px; object-fit: cover;">
            <div class="card-body">
              <h5 class="card-title">{{ $siswa->nama_siswa }}</h5>
              <h6 class="card-subtitle mb-2 text-muted">{{ $siswa->kode_siswa }} | {{ $siswa->jurusan_kelas }}</h6>
              <p class="card-text">{{ $siswa->deskripsi }}</p>
            </div>
          </div>
        </div>
        @endforeach
